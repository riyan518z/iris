...
if submitted:
    ...
    # Map numeric prediction to species names if needed
    label_map = {
        0: "Iris-setosa",
        1: "Iris-versicolor",
        2: "Iris-virginica"
    ...
    if isinstance(raw_pred, (int, float)) or str(raw_pred).isdigit():
        prediction = label_map.get(int(raw_pred), "Unknown")
    else:
    ...
    image_url = image_map.get(prediction)
    if image_url:
